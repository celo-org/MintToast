export const MASA_CDN_ABI = [
  ...
  {
    inputs: [{ internalType: "uint256", name: "yearsPeriod", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "identityId", type: "uint256" }],
    name: "getSoulNames",
    outputs: [{ internalType: "string[]", name: "sbtNames", type: "string[]" }],
    stateMutability: "view",
    type: "function",
  },
  {
